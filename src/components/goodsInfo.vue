	...
	<div id="app">
		<van-row class="col-2">
			...
			<van-col span="24" class="title">
				<a href="javaScript:;" @click.prevent="search_shows">{{
					"&lt;"
				}}</a>
				<h4>{{ actives[1] }}</h4>
			</van-col>
		...
		<van-pull-refresh v-model="isLoading" @refresh="onRefresh">
			...
			<div class="over">
				<van-row
					v-for="(img, index) in imageList.img_1"
					:key="img.id"
					class="lists"
				>
					...
					<van-col span="11" offset="1" class="goods_list">
						<div
							class="imgList"
							@click.stop="buy(imageList.img_2[index])"
						>
							<img
								v-lazy="imageList.img_2[index]"
								name="adapter"
							/>
						</div>
						<van-col span="24" class="lazy-left">
						...
						<van-col span="24" class="lazy-bottom">
							<h4>
								...
								>
								<div>{{ discount.dis_2[index] }}折</div>
							</h4>
						</van-col>
					</van-col>
				</van-row>
		...
		onRefresh() {
			setTimeout(() => {
				...
				for (let i = 0; i < 4; i++) {
					...
					this.limit_price.limit_p1.push(
						this.limit_price.limit_p1[i]
					);
					this.limit_price.limit_p2.push(
						this.limit_price.limit_p2[i]
					);

					this.original_price.origin_p1.push(
						this.original_price.origin_p1[i]
					);
					this.original_price.origin_p2.push(
						this.original_price.origin_p2[i]
					);
				...
				if (res.status == 200) {
					...
					switch (this.$route.params.id.toString()) {
						case "id_0":
							...
							this.limit_price.limit_p1 =
								data.id_0.limit_price[0];
							this.limit_price.limit_p2 =
								data.id_0.limit_price[1];

							this.original_price.origin_p1 =
								data.id_0.original_price[0];
							this.original_price.origin_p2 =
								data.id_0.original_price[1];
						...
						case "id_1":
							...
							this.limit_price.limit_p1 =
								data.id_1.limit_price[0];
							this.limit_price.limit_p2 =
								data.id_1.limit_price[1];

							this.original_price.origin_p1 =
								data.id_1.original_price[0];
							this.original_price.origin_p2 =
								data.id_1.original_price[1];
						...
						case "id_2":
							...
							this.limit_price.limit_p1 =
								data.id_2.limit_price[0];
							this.limit_price.limit_p2 =
								data.id_2.limit_price[1];

							this.original_price.origin_p1 =
								data.id_2.original_price[0];
							this.original_price.origin_p2 =
								data.id_2.original_price[1];
						...
						case "id_3":
							...
							this.limit_price.limit_p1 =
								data.id_3.limit_price[0];
							this.limit_price.limit_p2 =
								data.id_3.limit_price[1];

							this.original_price.origin_p1 =
								data.id_3.original_price[0];
							this.original_price.origin_p2 =
								data.id_3.original_price[1];
						...
						case "id_4":
							...
							this.limit_price.limit_p1 =
								data.id_4.limit_price[0];
							this.limit_price.limit_p2 =
								data.id_4.limit_price[1];

							this.original_price.origin_p1 =
								data.id_4.original_price[0];
							this.original_price.origin_p2 =
								data.id_4.original_price[1];
						...
						case "id_5":
							...
							this.limit_price.limit_p1 =
								data.id_5.limit_price[0];
							this.limit_price.limit_p2 =
								data.id_5.limit_price[1];

							this.original_price.origin_p1 =
								data.id_5.original_price[0];
							this.original_price.origin_p2 =
								data.id_5.original_price[1];
						...
						case "id_6":
							...
							this.limit_price.limit_p1 =
								data.id_6.limit_price[0];
							this.limit_price.limit_p2 =
								data.id_6.limit_price[1];

							this.original_price.origin_p1 =
								data.id_6.original_price[0];
							this.original_price.origin_p2 =
								data.id_6.original_price[1];
